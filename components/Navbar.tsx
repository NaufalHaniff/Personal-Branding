    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-8 pt-4 pb-2">
      ...
      >
        ...
        <a
          ...
          className="group inline-flex items-center px-3 py-1.5 rounded-lg border-2 border-black bg-neo-yellow text-black font-extrabold text-base tracking-tight shadow-[2px_2px_0px_0px_#000000] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_#000000] transition-all select-none"
        >
